  ...
  return (
    <header className={styles['header-container']}>
      <div>
        ...
        >
          Check out our most recent podcast <img src={ChevronRight} aria-hidden={true} alt=''></img>
        </a>
        <h1>The Free Community for Modern Learning.</h1>
        <p className={styles['tag-line']}>
          This is a community which provides{' '}
          <span className={styles['highlight']}>free hands-on training</span> in various fields of
          computer science and have an inclusive community focusing on a{' '}
        ...
        <div className={styles['links']}>
          ...
          <a
            ...
            rel='noopener noreferrer'
          >
            Visit youtube <img src={TopRightArrow} aria-hidden={true} alt=''></img>
          </a>
        </div>
      </div>
    </header>
