    ...
    <section>
      <div className={styles['courses-container']}>
        <div className={styles['info-container']}>
          <h2>Boost your career with our Complete Hands On Courses</h2>
          <p>
            <ul>
              <li>All courses are FREE while never compromising on quality.</li>
              <li>
                We cover every topic in detail with a hands-on approach and mentor you to stand out
                to get opportunities by breaking all the barriers.
              </li>
              <li>
