      ...
      <div className={styles['podcast-container']}>
        <div className={styles['info-container']}>
          ...
          <p className={styles['info']}>
            The Open Source Cafe, Out of Syllabus, KlassTime with Karuna, AMA session on Discord is
            an initiative to highlight the stories, journeys, tips & tricks of some of the amazing
