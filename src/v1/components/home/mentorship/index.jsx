    ...
    <section>
      <div className={styles['mentorship-container']}>
        <div className={styles['info-container']}>
          <h2>Roadmaps and Mentorship made by best in the industry</h2>
          <p>
            <ul>
              <li>
                ...
                including educational materials, communities to join, opportunities, and much more.
              </li>
              <li>
                <span className={styles['highlight']}>Roadmaps to help you stay on track,</span>{' '}
