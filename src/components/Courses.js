    ...
    <div className="courses">
      <div className="courses_text">
        ...
        <ul className="courses_ul">
          ...
          <li>
            We cover every topic in detail with a hands-on approach and <br />{" "}
            mentor you to stand out to get opportunities by breaking all <br />{" "}
            the barriers.
          </li>
          <li>
            Explore a wide range of courses including Data Structures & <br />{" "}
            Algorithms, Web Development, DevOps, Machine Learning, <br /> and
            more!
          </li>
        </ul>
